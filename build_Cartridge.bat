...
gfxcc -black fix.pal starfield.bmp playership.bmp playership_2.bmp playership_3.bmp bullet.bmp enemies.bmp -o test.spr
...
bin2elf playership_3.map playership_3 %NEODEV%\tmp\playership_3.o
