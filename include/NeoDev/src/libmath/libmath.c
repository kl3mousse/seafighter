// ++===================================================================++
// || libmath.c - Fixed point math routines functions for Neo Geo		||
// ++-------------------------------------------------------------------++
// || $Id: libmath.c,v 1.5 2001/04/26 11:36:01 fma Exp $				||
// ++-------------------------------------------------------------------++
// || Provides a *very* limited set of fixed point math routines.		||
// || No fdiv due to 68000 limitations.									||
// || Please note that in this library angles are 0..512 and not 0..360 ||
// || Also, you can add or substract directly fixed point values		||
// || without using fadd or fsub. This allows the compiler to optimize  ||
// || expressions and therefore is faster.								||
// ++-------------------------------------------------------------------||
// || Most of this code is borrowed from Allegro library.				||
// ++-------------------------------------------------------------------||
// || BGM: Guilty Gear X - Ending 2										||
// ++===================================================================++
...
//------------------------------------------------------------------------------
static const char Id[] = "libMath Ver 0.2 Build:"__DATE__" "__TIME__;
//------------------------------------------------------------------------------
